...
<section class="sec1 flex items-center justify-between pr-4 bg-gray-200">
  ...
  <a href="writings/poems/"><button class="border-black text-xl text-white bg-black btn">Start Reading</button></a>
    </div>
    ...
    <div class="container"> 
           ...
           {#each poems as poem}
             <div class="writing-box2">
                <h3>{poem.title}</h3>
                <a href={`/writings/poems/${poem.slug}`}><button>Start reading</button></a>
            </div>
        {/each}
